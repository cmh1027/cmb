...
class nnUNetTrainer(NetworkTrainer):
    def __init__(self, plans_file, fold, output_folder=None, checkpoint_base="ckpt/base", dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, fp16=False, use_pos_enc=False, frequencies=[8,16,32]):
        """
        :param deterministic:
    ...
    def initialize(self, training=True, force_load_plans=False, aug_mode="default"):
        """
        ...
        maybe_mkdir_p(join(self.output_folder, self.checkpoint_base))
        ...
        if training:
            ...
            if aug_mode == "default":
                self.tr_gen, self.val_gen = get_default_augmentation(self.dl_tr, self.dl_val,
                                                                    ...
                                                                    self.data_aug_params, use_pos_enc=self.use_pos_enc)

            elif aug_mode == "insane":
    ...
    def initialize_network(self):
        ...
        self.network = Generic_UNet(self.num_input_channels, self.base_num_features, self.num_classes, net_numpool,
                                    ...
                                    self.net_num_pool_op_kernel_sizes, self.net_conv_kernel_sizes, False, True, True, use_pos_enc=self.use_pos_enc)
    ...
    def get_basic_generators(self):
        ...
        if self.threeD:
            dl_tr = DataLoader3D(self.dataset_tr, self.basic_generator_patch_size, self.patch_size, self.batch_size,
                                 ...
                                 pad_mode="constant", pad_sides=self.pad_all_sides, memmap_mode='r', frequenices=self.frequencies)
